 ...
 */
final class Version20200603225830 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE formula (id INT AUTO_INCREMENT NOT NULL, content VARCHAR(2048) NOT NULL, timeinterval VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
