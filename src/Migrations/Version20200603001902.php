 ...
 */
final class Version20200603001902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE instrument_list_formula (instrument_list_id INT NOT NULL, formula_id INT NOT NULL, INDEX IDX_4AE2B57459D692A (instrument_list_id), INDEX IDX_4AE2B57A50A6386 (formula_id), PRIMARY KEY(instrument_list_id, formula_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE instrument_list_formula ADD CONSTRAINT FK_4AE2B57459D692A FOREIGN KEY (instrument_list_id) REFERENCES instrument_list (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE instrument_list_formula ADD CONSTRAINT FK_4AE2B57A50A6386 FOREIGN KEY (formula_id) REFERENCES formula (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE instrument_list_formula DROP FOREIGN KEY FK_4AE2B57A50A6386');
        $this->addSql('DROP TABLE instrument_list_formula');
